...
# progress.sh,data-inventory.sh,measure.sh,phase1-gate.sh} and
...
for s in method.conf task-audit.sh gate.sh progress.sh data-inventory.sh measure.sh; do put "$tpl/scripts/$s" "scripts/$s"; done
